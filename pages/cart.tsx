  ...
  const total = getTotal(cart);
    return (
        <div className="container mt-15 d-flex flex-column">
                    ...
                    <div className="row mt-5 g-0 mb-4 d-flex align-items-center flex-row ">
                        ...
                        <div className="col-md-8 d-flex flex-column align-items-center">
                            <div className="card-body d-flex flex-row gap-3 align-items-center">
                                ...
                                <div className={`${styles.quantityControls} d-flex flex-row align-items-center`}>
                                    <button className="btn btn-secondary" onClick={() => decrementQty(item.id)}>
                                        -
                                    </button>
                                    <input type="number" className={`${styles.quantityInput} form-control`} value={item.quantity} readOnly />
                                    <button className="btn btn-secondary" onClick={() => IncrementQty(item.id)}>
                                        +
                                    </button>
                                </div>
            ...
            <div className={styles.totalPrice} mt-4>
                    {cart.length > 0 && (
